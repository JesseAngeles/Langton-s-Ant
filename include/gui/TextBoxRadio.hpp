#ifndef TEXT_BOX_RADIO_HPP
#define TEXT_BOX_RADIO_HPP
...
class TextBoxRadio : public TextBox
{
private:
...
public:
    TextBoxRadio(GUI *gui, Text text)
        : TextBox(Vector2f(110, 430), Vector2f(100, 50), Color(Color::White), text, "", 20),
          gui(gui)
    {
        this->text.setCharacterSize(10);

        // Definir el callback para el evento onClick usando std::bind
        this->fun = std::bind(&TextBoxRadio::functionButton, this, std::placeholders::_1);
